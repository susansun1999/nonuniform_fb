...
// Generated on: 2021-05-07 09:59:26
// -------------------------------------------------------------
...
////////////////////////////////////////////////////////////////
  ...
  // Type Definitions
  // Constants
  parameter signed [15:0] coeff1 = 16'b1111111111111011; //sfix16_En17
  ...
  parameter signed [15:0] coeff4 = 16'b0000000000011011; //sfix16_En17
  parameter signed [15:0] coeff5 = 16'b1111111111011100; //sfix16_En17
  parameter signed [15:0] coeff6 = 16'b0000000000000011; //sfix16_En17
  parameter signed [15:0] coeff7 = 16'b0000000001000100; //sfix16_En17
  parameter signed [15:0] coeff8 = 16'b1111111110001001; //sfix16_En17
  parameter signed [15:0] coeff9 = 16'b0000000001010111; //sfix16_En17
  parameter signed [15:0] coeff10 = 16'b0000000000100000; //sfix16_En17
  parameter signed [15:0] coeff11 = 16'b1111111101101001; //sfix16_En17
  parameter signed [15:0] coeff12 = 16'b0000000010101000; //sfix16_En17
  parameter signed [15:0] coeff13 = 16'b1111111110111110; //sfix16_En17
  parameter signed [15:0] coeff14 = 16'b1111111111000110; //sfix16_En17
  parameter signed [15:0] coeff15 = 16'b0000000001011000; //sfix16_En17
  parameter signed [15:0] coeff16 = 16'b1111111111101000; //sfix16_En17
  parameter signed [15:0] coeff17 = 16'b1111111111110110; //sfix16_En17
  parameter signed [15:0] coeff18 = 16'b1111111110100000; //sfix16_En17
  parameter signed [15:0] coeff19 = 16'b0000000100001011; //sfix16_En17
  parameter signed [15:0] coeff20 = 16'b1111111011101101; //sfix16_En17
  parameter signed [15:0] coeff21 = 16'b1111111111100010; //sfix16_En17
  parameter signed [15:0] coeff22 = 16'b0000000111101110; //sfix16_En17
  parameter signed [15:0] coeff23 = 16'b1111110100110000; //sfix16_En17
  parameter signed [15:0] coeff24 = 16'b0000000110100110; //sfix16_En17
  parameter signed [15:0] coeff25 = 16'b0000000011110111; //sfix16_En17
  parameter signed [15:0] coeff26 = 16'b1111110011111101; //sfix16_En17
  parameter signed [15:0] coeff27 = 16'b0000001011011000; //sfix16_En17
  parameter signed [15:0] coeff28 = 16'b1111111100101110; //sfix16_En17
  parameter signed [15:0] coeff29 = 16'b1111111100000000; //sfix16_En17
  parameter signed [15:0] coeff30 = 16'b0000000100000111; //sfix16_En17
  parameter signed [15:0] coeff31 = 16'b0000000000010111; //sfix16_En17
  parameter signed [15:0] coeff32 = 16'b1111111111100010; //sfix16_En17
  parameter signed [15:0] coeff33 = 16'b1111110111101100; //sfix16_En17
  parameter signed [15:0] coeff34 = 16'b0000010010011011; //sfix16_En17
  parameter signed [15:0] coeff35 = 16'b1111110000001011; //sfix16_En17
  parameter signed [15:0] coeff36 = 16'b1111111011001000; //sfix16_En17
  parameter signed [15:0] coeff37 = 16'b0000011110110111; //sfix16_En17
  parameter signed [15:0] coeff38 = 16'b1111011000100100; //sfix16_En17
  parameter signed [15:0] coeff39 = 16'b0000010011000110; //sfix16_En17
  parameter signed [15:0] coeff40 = 16'b0000010001000010; //sfix16_En17
  parameter signed [15:0] coeff41 = 16'b1111010111011111; //sfix16_En17
  parameter signed [15:0] coeff42 = 16'b0000100001101000; //sfix16_En17
  parameter signed [15:0] coeff43 = 16'b1111111001010100; //sfix16_En17
  parameter signed [15:0] coeff44 = 16'b1111110011110010; //sfix16_En17
  parameter signed [15:0] coeff45 = 16'b0000000111001011; //sfix16_En17
  parameter signed [15:0] coeff46 = 16'b0000000110111100; //sfix16_En17
  parameter signed [15:0] coeff47 = 16'b0000000000100100; //sfix16_En17
  parameter signed [15:0] coeff48 = 16'b1111011001001110; //sfix16_En17
  parameter signed [15:0] coeff49 = 16'b0001001010011001; //sfix16_En17
  parameter signed [15:0] coeff50 = 16'b1111001000000101; //sfix16_En17
  parameter signed [15:0] coeff51 = 16'b1111011111111011; //sfix16_En17
  parameter signed [15:0] coeff52 = 16'b0010001000110011; //sfix16_En17
  parameter signed [15:0] coeff53 = 16'b1101011001000001; //sfix16_En17
  parameter signed [15:0] coeff54 = 16'b0001000110011111; //sfix16_En17
  parameter signed [15:0] coeff55 = 16'b0001101010011011; //sfix16_En17
  parameter signed [15:0] coeff56 = 16'b1100010001110100; //sfix16_En17
  parameter signed [15:0] coeff57 = 16'b0011010101110001; //sfix16_En17
  parameter signed [15:0] coeff58 = 16'b1111100000000001; //sfix16_En17
  parameter signed [15:0] coeff59 = 16'b1101000110100010; //sfix16_En17
