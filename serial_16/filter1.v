...
// Generated on: 2021-05-07 09:58:50
// -------------------------------------------------------------
...
module filter1
  ...
  output  signed [38:0] filter_out; //sfix39_En34
...
////////////////////////////////////////////////////////////////
  ...
  // Type Definitions
  // Constants
  parameter signed [15:0] coeff1 = 16'b0000000000100100; //sfix16_En19
  parameter signed [15:0] coeff2 = 16'b0000000000100111; //sfix16_En19
  parameter signed [15:0] coeff3 = 16'b0000000000101000; //sfix16_En19
  parameter signed [15:0] coeff4 = 16'b0000000000100101; //sfix16_En19
  parameter signed [15:0] coeff5 = 16'b0000000000011100; //sfix16_En19
  parameter signed [15:0] coeff6 = 16'b0000000000001110; //sfix16_En19
  parameter signed [15:0] coeff7 = 16'b1111111111111000; //sfix16_En19
  parameter signed [15:0] coeff8 = 16'b1111111111011010; //sfix16_En19
  parameter signed [15:0] coeff9 = 16'b1111111110110010; //sfix16_En19
  parameter signed [15:0] coeff10 = 16'b1111111110000001; //sfix16_En19
  parameter signed [15:0] coeff11 = 16'b1111111101000101; //sfix16_En19
  parameter signed [15:0] coeff12 = 16'b1111111011111111; //sfix16_En19
  parameter signed [15:0] coeff13 = 16'b1111111010101110; //sfix16_En19
  parameter signed [15:0] coeff14 = 16'b1111111001010011; //sfix16_En19
  parameter signed [15:0] coeff15 = 16'b1111110111101111; //sfix16_En19
  parameter signed [15:0] coeff16 = 16'b1111110110000011; //sfix16_En19
  parameter signed [15:0] coeff17 = 16'b1111110100010001; //sfix16_En19
  parameter signed [15:0] coeff18 = 16'b1111110010011100; //sfix16_En19
  parameter signed [15:0] coeff19 = 16'b1111110000100111; //sfix16_En19
  parameter signed [15:0] coeff20 = 16'b1111101110110100; //sfix16_En19
  parameter signed [15:0] coeff21 = 16'b1111101101001000; //sfix16_En19
  parameter signed [15:0] coeff22 = 16'b1111101011100111; //sfix16_En19
  parameter signed [15:0] coeff23 = 16'b1111101010010111; //sfix16_En19
  parameter signed [15:0] coeff24 = 16'b1111101001011011; //sfix16_En19
  parameter signed [15:0] coeff25 = 16'b1111101000111010; //sfix16_En19
  parameter signed [15:0] coeff26 = 16'b1111101000111001; //sfix16_En19
  parameter signed [15:0] coeff27 = 16'b1111101001011110; //sfix16_En19
  parameter signed [15:0] coeff28 = 16'b1111101010101110; //sfix16_En19
  parameter signed [15:0] coeff29 = 16'b1111101100101111; //sfix16_En19
  parameter signed [15:0] coeff30 = 16'b1111101111100101; //sfix16_En19
  parameter signed [15:0] coeff31 = 16'b1111110011010110; //sfix16_En19
  parameter signed [15:0] coeff32 = 16'b1111111000000101; //sfix16_En19
  parameter signed [15:0] coeff33 = 16'b1111111101110110; //sfix16_En19
  parameter signed [15:0] coeff34 = 16'b0000000100101011; //sfix16_En19
  parameter signed [15:0] coeff35 = 16'b0000001100100110; //sfix16_En19
  parameter signed [15:0] coeff36 = 16'b0000010101100111; //sfix16_En19
  parameter signed [15:0] coeff37 = 16'b0000011111101101; //sfix16_En19
  parameter signed [15:0] coeff38 = 16'b0000101010110111; //sfix16_En19
  parameter signed [15:0] coeff39 = 16'b0000110111000010; //sfix16_En19
  parameter signed [15:0] coeff40 = 16'b0001000100001000; //sfix16_En19
  parameter signed [15:0] coeff41 = 16'b0001010010000110; //sfix16_En19
  parameter signed [15:0] coeff42 = 16'b0001100000110100; //sfix16_En19
  parameter signed [15:0] coeff43 = 16'b0001110000001001; //sfix16_En19
  parameter signed [15:0] coeff44 = 16'b0001111111111110; //sfix16_En19
  parameter signed [15:0] coeff45 = 16'b0010010000001000; //sfix16_En19
  parameter signed [15:0] coeff46 = 16'b0010100000011100; //sfix16_En19
  parameter signed [15:0] coeff47 = 16'b0010110000101111; //sfix16_En19
  parameter signed [15:0] coeff48 = 16'b0011000000110110; //sfix16_En19
  parameter signed [15:0] coeff49 = 16'b0011010000100100; //sfix16_En19
  parameter signed [15:0] coeff50 = 16'b0011011111101101; //sfix16_En19
  parameter signed [15:0] coeff51 = 16'b0011101110000101; //sfix16_En19
  parameter signed [15:0] coeff52 = 16'b0011111011100001; //sfix16_En19
  parameter signed [15:0] coeff53 = 16'b0100000111110101; //sfix16_En19
  parameter signed [15:0] coeff54 = 16'b0100010010110110; //sfix16_En19
  parameter signed [15:0] coeff55 = 16'b0100011100011101; //sfix16_En19
  parameter signed [15:0] coeff56 = 16'b0100100100011111; //sfix16_En19
  parameter signed [15:0] coeff57 = 16'b0100101010110111; //sfix16_En19
  parameter signed [15:0] coeff58 = 16'b0100101111011110; //sfix16_En19
  parameter signed [15:0] coeff59 = 16'b0100110010010001; //sfix16_En19
  parameter signed [15:0] coeff60 = 16'b0100110011001101; //sfix16_En19
  ...
  reg  signed [38:0] acc_final; // sfix39_En34
  reg  signed [38:0] acc_out_1; // sfix39_En34
  wire signed [32:0] product_1; // sfix33_En34
  wire signed [15:0] product_1_mux; // sfix16_En19
  wire signed [38:0] prod_typeconvert_1; // sfix39_En34
  wire signed [38:0] acc_sum_1; // sfix39_En34
  wire signed [38:0] acc_in_1; // sfix39_En34
  wire signed [38:0] add_signext_2; // sfix39_En34
  wire signed [38:0] add_signext_3; // sfix39_En34
  wire signed [39:0] add_temp; // sfix40_En34
  reg  signed [38:0] output_register; // sfix39_En34
