...
// Generated on: 2021-05-22 14:29:49
// -------------------------------------------------------------
...
////////////////////////////////////////////////////////////////
  ...
  parameter signed [7:0] coeff31 = 8'b11111101; //sfix8_En10
  ...
  parameter signed [7:0] coeff35 = 8'b00000101; //sfix8_En10
  parameter signed [7:0] coeff36 = 8'b00001010; //sfix8_En10
  parameter signed [7:0] coeff37 = 8'b00001100; //sfix8_En10
  parameter signed [7:0] coeff38 = 8'b00001011; //sfix8_En10
  parameter signed [7:0] coeff39 = 8'b00000110; //sfix8_En10
  parameter signed [7:0] coeff40 = 8'b11111100; //sfix8_En10
  parameter signed [7:0] coeff41 = 8'b11110001; //sfix8_En10
  parameter signed [7:0] coeff42 = 8'b11101000; //sfix8_En10
  parameter signed [7:0] coeff43 = 8'b11100101; //sfix8_En10
  parameter signed [7:0] coeff44 = 8'b11101010; //sfix8_En10
  parameter signed [7:0] coeff45 = 8'b11111000; //sfix8_En10
  parameter signed [7:0] coeff46 = 8'b00001011; //sfix8_En10
  parameter signed [7:0] coeff47 = 8'b00011110; //sfix8_En10
  parameter signed [7:0] coeff48 = 8'b00101010; //sfix8_En10
  parameter signed [7:0] coeff49 = 8'b00101011; //sfix8_En10
  parameter signed [7:0] coeff50 = 8'b00011111; //sfix8_En10
  parameter signed [7:0] coeff51 = 8'b00001000; //sfix8_En10
  parameter signed [7:0] coeff52 = 8'b11101011; //sfix8_En10
  parameter signed [7:0] coeff53 = 8'b11010011; //sfix8_En10
  parameter signed [7:0] coeff54 = 8'b11000110; //sfix8_En10
  parameter signed [7:0] coeff55 = 8'b11001010; //sfix8_En10
  parameter signed [7:0] coeff56 = 8'b11011110; //sfix8_En10
  parameter signed [7:0] coeff57 = 8'b11111101; //sfix8_En10
  parameter signed [7:0] coeff58 = 8'b00011110; //sfix8_En10
  parameter signed [7:0] coeff59 = 8'b00110111; //sfix8_En10
