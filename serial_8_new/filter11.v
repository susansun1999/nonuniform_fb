...
// Generated on: 2021-05-22 14:30:02
// -------------------------------------------------------------
...
////////////////////////////////////////////////////////////////
  ...
  parameter signed [7:0] coeff31 = 8'b11111111; //sfix8_En10
  parameter signed [7:0] coeff32 = 8'b00000011; //sfix8_En10
  parameter signed [7:0] coeff33 = 8'b00000101; //sfix8_En10
  ...
  parameter signed [7:0] coeff38 = 8'b00001111; //sfix8_En10
  parameter signed [7:0] coeff39 = 8'b00001001; //sfix8_En10
  parameter signed [7:0] coeff40 = 8'b11110101; //sfix8_En10
  parameter signed [7:0] coeff41 = 8'b11101010; //sfix8_En10
  parameter signed [7:0] coeff42 = 8'b11111010; //sfix8_En10
  parameter signed [7:0] coeff43 = 8'b00010110; //sfix8_En10
  parameter signed [7:0] coeff44 = 8'b00011100; //sfix8_En10
  parameter signed [7:0] coeff45 = 8'b11111110; //sfix8_En10
  parameter signed [7:0] coeff46 = 8'b11011101; //sfix8_En10
  parameter signed [7:0] coeff47 = 8'b11100011; //sfix8_En10
  parameter signed [7:0] coeff48 = 8'b00001111; //sfix8_En10
  parameter signed [7:0] coeff49 = 8'b00101110; //sfix8_En10
  parameter signed [7:0] coeff50 = 8'b00010111; //sfix8_En10
  parameter signed [7:0] coeff51 = 8'b11100001; //sfix8_En10
  parameter signed [7:0] coeff52 = 8'b11001100; //sfix8_En10
  parameter signed [7:0] coeff53 = 8'b11110110; //sfix8_En10
  parameter signed [7:0] coeff54 = 8'b00110000; //sfix8_En10
  parameter signed [7:0] coeff55 = 8'b00110011; //sfix8_En10
  parameter signed [7:0] coeff56 = 8'b11111001; //sfix8_En10
  parameter signed [7:0] coeff57 = 8'b11000100; //sfix8_En10
  parameter signed [7:0] coeff58 = 8'b11010110; //sfix8_En10
  parameter signed [7:0] coeff59 = 8'b00011010; //sfix8_En10
