clear
% parameters
wordlength = 11; % determines precision
...
%               60,59,59,59,59,59,59,59,58,59,59,60,60,60,59,49];
    serial = [52,53,52,55,52,54,56,55,54,54,55,54,56,51,51,42;...
      ...
      filter_obj.generatehdl('InputDataType', T, 'Name', name,'SerialPartition',serial(wordlength-10,filt_idx),...
