...
// Generated on: 2021-05-17 14:42:32
// -------------------------------------------------------------
...
////////////////////////////////////////////////////////////////
  ...
  // Type Definitions
  // Constants
  parameter signed [15:0] coeff1 = 16'b0000000000000110; //sfix16_En19
  parameter signed [15:0] coeff2 = 16'b0000000000001000; //sfix16_En19
  parameter signed [15:0] coeff3 = 16'b0000000000001001; //sfix16_En19
  parameter signed [15:0] coeff4 = 16'b0000000000001001; //sfix16_En19
  parameter signed [15:0] coeff5 = 16'b0000000000001000; //sfix16_En19
  parameter signed [15:0] coeff6 = 16'b0000000000000100; //sfix16_En19
  parameter signed [15:0] coeff7 = 16'b1111111111111101; //sfix16_En19
  parameter signed [15:0] coeff8 = 16'b1111111111110011; //sfix16_En19
  parameter signed [15:0] coeff9 = 16'b1111111111100100; //sfix16_En19
  parameter signed [15:0] coeff10 = 16'b1111111111001111; //sfix16_En19
  parameter signed [15:0] coeff11 = 16'b1111111110110100; //sfix16_En19
  parameter signed [15:0] coeff12 = 16'b1111111110010001; //sfix16_En19
  parameter signed [15:0] coeff13 = 16'b1111111101101000; //sfix16_En19
  parameter signed [15:0] coeff14 = 16'b1111111100110110; //sfix16_En19
  parameter signed [15:0] coeff15 = 16'b1111111011111100; //sfix16_En19
  parameter signed [15:0] coeff16 = 16'b1111111010111011; //sfix16_En19
  parameter signed [15:0] coeff17 = 16'b1111111001110010; //sfix16_En19
  parameter signed [15:0] coeff18 = 16'b1111111000100100; //sfix16_En19
  parameter signed [15:0] coeff19 = 16'b1111110111010000; //sfix16_En19
  parameter signed [15:0] coeff20 = 16'b1111110101111011; //sfix16_En19
  parameter signed [15:0] coeff21 = 16'b1111110100100101; //sfix16_En19
  parameter signed [15:0] coeff22 = 16'b1111110011010011; //sfix16_En19
  parameter signed [15:0] coeff23 = 16'b1111110010001000; //sfix16_En19
  parameter signed [15:0] coeff24 = 16'b1111110001001001; //sfix16_En19
  parameter signed [15:0] coeff25 = 16'b1111110000011010; //sfix16_En19
  parameter signed [15:0] coeff26 = 16'b1111110000000000; //sfix16_En19
  parameter signed [15:0] coeff27 = 16'b1111110000000010; //sfix16_En19
  parameter signed [15:0] coeff28 = 16'b1111110000100100; //sfix16_En19
  parameter signed [15:0] coeff29 = 16'b1111110001101110; //sfix16_En19
  parameter signed [15:0] coeff30 = 16'b1111110011100101; //sfix16_En19
  parameter signed [15:0] coeff31 = 16'b1111110110001111; //sfix16_En19
  parameter signed [15:0] coeff32 = 16'b1111111001110010; //sfix16_En19
  parameter signed [15:0] coeff33 = 16'b1111111110010010; //sfix16_En19
  parameter signed [15:0] coeff34 = 16'b0000000011110011; //sfix16_En19
  parameter signed [15:0] coeff35 = 16'b0000001010011011; //sfix16_En19
  parameter signed [15:0] coeff36 = 16'b0000010010001010; //sfix16_En19
  parameter signed [15:0] coeff37 = 16'b0000011011000011; //sfix16_En19
  parameter signed [15:0] coeff38 = 16'b0000100101000101; //sfix16_En19
  parameter signed [15:0] coeff39 = 16'b0000110000001111; //sfix16_En19
  parameter signed [15:0] coeff40 = 16'b0000111100011111; //sfix16_En19
  parameter signed [15:0] coeff41 = 16'b0001001001110001; //sfix16_En19
  parameter signed [15:0] coeff42 = 16'b0001010111111110; //sfix16_En19
  parameter signed [15:0] coeff43 = 16'b0001100110111111; //sfix16_En19
  parameter signed [15:0] coeff44 = 16'b0001110110101100; //sfix16_En19
  parameter signed [15:0] coeff45 = 16'b0010000110111010; //sfix16_En19
  parameter signed [15:0] coeff46 = 16'b0010010111011111; //sfix16_En19
  parameter signed [15:0] coeff47 = 16'b0010101000001110; //sfix16_En19
  parameter signed [15:0] coeff48 = 16'b0010111000111010; //sfix16_En19
  parameter signed [15:0] coeff49 = 16'b0011001001010110; //sfix16_En19
  parameter signed [15:0] coeff50 = 16'b0011011001010011; //sfix16_En19
  parameter signed [15:0] coeff51 = 16'b0011101000100011; //sfix16_En19
  parameter signed [15:0] coeff52 = 16'b0011110110111001; //sfix16_En19
  parameter signed [15:0] coeff53 = 16'b0100000100000111; //sfix16_En19
  parameter signed [15:0] coeff54 = 16'b0100010000000000; //sfix16_En19
  parameter signed [15:0] coeff55 = 16'b0100011010011010; //sfix16_En19
  parameter signed [15:0] coeff56 = 16'b0100100011001001; //sfix16_En19
  parameter signed [15:0] coeff57 = 16'b0100101010000101; //sfix16_En19
  parameter signed [15:0] coeff58 = 16'b0100101111001000; //sfix16_En19
  parameter signed [15:0] coeff59 = 16'b0100110010001011; //sfix16_En19
