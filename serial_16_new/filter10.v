...
// Generated on: 2021-05-17 14:42:58
// -------------------------------------------------------------
...
////////////////////////////////////////////////////////////////
  ...
  // Type Definitions
  // Constants
  parameter signed [15:0] coeff1 = 16'b0000000000000000; //sfix16_En18
  parameter signed [15:0] coeff2 = 16'b1111111111111001; //sfix16_En18
  parameter signed [15:0] coeff3 = 16'b1111111111110011; //sfix16_En18
  parameter signed [15:0] coeff4 = 16'b1111111111111011; //sfix16_En18
  parameter signed [15:0] coeff5 = 16'b0000000000010101; //sfix16_En18
  parameter signed [15:0] coeff6 = 16'b0000000000101011; //sfix16_En18
  parameter signed [15:0] coeff7 = 16'b0000000000010111; //sfix16_En18
  parameter signed [15:0] coeff8 = 16'b1111111111010101; //sfix16_En18
  parameter signed [15:0] coeff9 = 16'b1111111110011100; //sfix16_En18
  parameter signed [15:0] coeff10 = 16'b1111111110111010; //sfix16_En18
  parameter signed [15:0] coeff11 = 16'b0000000000111100; //sfix16_En18
  parameter signed [15:0] coeff12 = 16'b0000000010111001; //sfix16_En18
  parameter signed [15:0] coeff13 = 16'b0000000010011100; //sfix16_En18
  parameter signed [15:0] coeff14 = 16'b1111111111001001; //sfix16_En18
  parameter signed [15:0] coeff15 = 16'b1111111011101010; //sfix16_En18
  parameter signed [15:0] coeff16 = 16'b1111111011101100; //sfix16_En18
  parameter signed [15:0] coeff17 = 16'b0000000000001010; //sfix16_En18
  parameter signed [15:0] coeff18 = 16'b0000000101011010; //sfix16_En18
  parameter signed [15:0] coeff19 = 16'b0000000110001100; //sfix16_En18
  parameter signed [15:0] coeff20 = 16'b0000000001000111; //sfix16_En18
  parameter signed [15:0] coeff21 = 16'b1111111010101000; //sfix16_En18
  parameter signed [15:0] coeff22 = 16'b1111111000111101; //sfix16_En18
  parameter signed [15:0] coeff23 = 16'b1111111101101011; //sfix16_En18
  parameter signed [15:0] coeff24 = 16'b0000000011110101; //sfix16_En18
  parameter signed [15:0] coeff25 = 16'b0000000101011100; //sfix16_En18
  parameter signed [15:0] coeff26 = 16'b0000000010000100; //sfix16_En18
  parameter signed [15:0] coeff27 = 16'b1111111110111111; //sfix16_En18
  parameter signed [15:0] coeff28 = 16'b0000000000000000; //sfix16_En18
  parameter signed [15:0] coeff29 = 16'b0000000001111000; //sfix16_En18
  parameter signed [15:0] coeff30 = 16'b1111111110010010; //sfix16_En18
  parameter signed [15:0] coeff31 = 16'b1111110110000100; //sfix16_En18
  parameter signed [15:0] coeff32 = 16'b1111110100000111; //sfix16_En18
  parameter signed [15:0] coeff33 = 16'b0000000001111000; //sfix16_En18
  parameter signed [15:0] coeff34 = 16'b0000010111101101; //sfix16_En18
  parameter signed [15:0] coeff35 = 16'b0000011101111000; //sfix16_En18
  parameter signed [15:0] coeff36 = 16'b0000000011111010; //sfix16_En18
  parameter signed [15:0] coeff37 = 16'b1111011001001010; //sfix16_En18
  parameter signed [15:0] coeff38 = 16'b1111000111110000; //sfix16_En18
  parameter signed [15:0] coeff39 = 16'b1111101101000110; //sfix16_En18
  parameter signed [15:0] coeff40 = 16'b0000110011010101; //sfix16_En18
  parameter signed [15:0] coeff41 = 16'b0001011001001110; //sfix16_En18
  parameter signed [15:0] coeff42 = 16'b0000101101001110; //sfix16_En18
  parameter signed [15:0] coeff43 = 16'b1111000111101101; //sfix16_En18
  parameter signed [15:0] coeff44 = 16'b1110000011011101; //sfix16_En18
  parameter signed [15:0] coeff45 = 16'b1110101101011000; //sfix16_En18
  parameter signed [15:0] coeff46 = 16'b0000110001011000; //sfix16_En18
  parameter signed [15:0] coeff47 = 16'b0010011100001101; //sfix16_En18
  parameter signed [15:0] coeff48 = 16'b0001111111111100; //sfix16_En18
  parameter signed [15:0] coeff49 = 16'b1111100011110111; //sfix16_En18
  parameter signed [15:0] coeff50 = 16'b1101001110011010; //sfix16_En18
  parameter signed [15:0] coeff51 = 16'b1101010000110000; //sfix16_En18
  parameter signed [15:0] coeff52 = 16'b1111111001001110; //sfix16_En18
  parameter signed [15:0] coeff53 = 16'b0010110111010110; //sfix16_En18
  parameter signed [15:0] coeff54 = 16'b0011011001000001; //sfix16_En18
  parameter signed [15:0] coeff55 = 16'b0000110011010110; //sfix16_En18
  parameter signed [15:0] coeff56 = 16'b1101010101001110; //sfix16_En18
  parameter signed [15:0] coeff57 = 16'b1100001010010000; //sfix16_En18
  parameter signed [15:0] coeff58 = 16'b1110011101001110; //sfix16_En18
  parameter signed [15:0] coeff59 = 16'b0010001101000001; //sfix16_En18
