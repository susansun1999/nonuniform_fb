...
// Generated on: 2021-05-17 14:43:12
// -------------------------------------------------------------
...
////////////////////////////////////////////////////////////////
  ...
  // Type Definitions
  // Constants
  parameter signed [15:0] coeff1 = 16'b1111111111111111; //sfix16_En17
  parameter signed [15:0] coeff2 = 16'b0000000000000000; //sfix16_En17
  parameter signed [15:0] coeff3 = 16'b1111111111111111; //sfix16_En17
  parameter signed [15:0] coeff4 = 16'b0000000000000111; //sfix16_En17
  parameter signed [15:0] coeff5 = 16'b1111111111110110; //sfix16_En17
  parameter signed [15:0] coeff6 = 16'b0000000000000001; //sfix16_En17
  parameter signed [15:0] coeff7 = 16'b0000000000010110; //sfix16_En17
  parameter signed [15:0] coeff8 = 16'b1111111111010111; //sfix16_En17
  parameter signed [15:0] coeff9 = 16'b0000000000100000; //sfix16_En17
  parameter signed [15:0] coeff10 = 16'b0000000000001100; //sfix16_En17
  parameter signed [15:0] coeff11 = 16'b1111111111000010; //sfix16_En17
  parameter signed [15:0] coeff12 = 16'b0000000001001000; //sfix16_En17
  parameter signed [15:0] coeff13 = 16'b1111111111100010; //sfix16_En17
  parameter signed [15:0] coeff14 = 16'b1111111111100101; //sfix16_En17
  parameter signed [15:0] coeff15 = 16'b0000000000101011; //sfix16_En17
  parameter signed [15:0] coeff16 = 16'b1111111111110100; //sfix16_En17
  parameter signed [15:0] coeff17 = 16'b1111111111111011; //sfix16_En17
  parameter signed [15:0] coeff18 = 16'b1111111111001100; //sfix16_En17
  parameter signed [15:0] coeff19 = 16'b0000000010011000; //sfix16_En17
  parameter signed [15:0] coeff20 = 16'b1111111101011111; //sfix16_En17
  parameter signed [15:0] coeff21 = 16'b1111111111101110; //sfix16_En17
  parameter signed [15:0] coeff22 = 16'b0000000100110100; //sfix16_En17
  parameter signed [15:0] coeff23 = 16'b1111111000110011; //sfix16_En17
  parameter signed [15:0] coeff24 = 16'b0000000100010110; //sfix16_En17
  parameter signed [15:0] coeff25 = 16'b0000000010100111; //sfix16_En17
  parameter signed [15:0] coeff26 = 16'b1111110111101010; //sfix16_En17
  parameter signed [15:0] coeff27 = 16'b0000001000000100; //sfix16_En17
  parameter signed [15:0] coeff28 = 16'b1111111101100111; //sfix16_En17
  parameter signed [15:0] coeff29 = 16'b1111111101000011; //sfix16_En17
  parameter signed [15:0] coeff30 = 16'b0000000011000111; //sfix16_En17
  parameter signed [15:0] coeff31 = 16'b0000000000010010; //sfix16_En17
  parameter signed [15:0] coeff32 = 16'b1111111111101001; //sfix16_En17
  parameter signed [15:0] coeff33 = 16'b1111111001010111; //sfix16_En17
  parameter signed [15:0] coeff34 = 16'b0000001111000000; //sfix16_En17
  parameter signed [15:0] coeff35 = 16'b1111110010111010; //sfix16_En17
  parameter signed [15:0] coeff36 = 16'b1111111011111010; //sfix16_En17
  parameter signed [15:0] coeff37 = 16'b0000011010010100; //sfix16_En17
  parameter signed [15:0] coeff38 = 16'b1111011101111000; //sfix16_En17
  parameter signed [15:0] coeff39 = 16'b0000010000101111; //sfix16_En17
  parameter signed [15:0] coeff40 = 16'b0000001111001000; //sfix16_En17
  parameter signed [15:0] coeff41 = 16'b1111011011100110; //sfix16_En17
  parameter signed [15:0] coeff42 = 16'b0000011110100011; //sfix16_En17
  parameter signed [15:0] coeff43 = 16'b1111111001110111; //sfix16_En17
  parameter signed [15:0] coeff44 = 16'b1111110100101011; //sfix16_En17
  parameter signed [15:0] coeff45 = 16'b0000000110101101; //sfix16_En17
  parameter signed [15:0] coeff46 = 16'b0000000110100100; //sfix16_En17
  parameter signed [15:0] coeff47 = 16'b0000000000100011; //sfix16_En17
  parameter signed [15:0] coeff48 = 16'b1111011010110100; //sfix16_En17
  parameter signed [15:0] coeff49 = 16'b0001000111110100; //sfix16_En17
  parameter signed [15:0] coeff50 = 16'b1111001001101011; //sfix16_En17
  parameter signed [15:0] coeff51 = 16'b1111100000101011; //sfix16_En17
  parameter signed [15:0] coeff52 = 16'b0010000110010010; //sfix16_En17
  parameter signed [15:0] coeff53 = 16'b1101011011010111; //sfix16_En17
  parameter signed [15:0] coeff54 = 16'b0001000101110001; //sfix16_En17
  parameter signed [15:0] coeff55 = 16'b0001101001101010; //sfix16_En17
  parameter signed [15:0] coeff56 = 16'b1100010010111011; //sfix16_En17
  parameter signed [15:0] coeff57 = 16'b0011010101001110; //sfix16_En17
  parameter signed [15:0] coeff58 = 16'b1111100000000011; //sfix16_En17
  parameter signed [15:0] coeff59 = 16'b1101000110100110; //sfix16_En17
  parameter signed [15:0] coeff60 = 16'b0100011001100110; //sfix16_En17
