...
// Generated on: 2021-05-17 14:23:55
// -------------------------------------------------------------
...
////////////////////////////////////////////////////////////////
  ...
  // Type Definitions
  // Constants
  parameter signed [14:0] coeff1 = 15'b000000000000011; //sfix15_En18
  parameter signed [14:0] coeff2 = 15'b000000000000100; //sfix15_En18
  parameter signed [14:0] coeff3 = 15'b000000000000100; //sfix15_En18
  parameter signed [14:0] coeff4 = 15'b000000000000101; //sfix15_En18
  parameter signed [14:0] coeff5 = 15'b000000000000100; //sfix15_En18
  parameter signed [14:0] coeff6 = 15'b000000000000010; //sfix15_En18
  parameter signed [14:0] coeff7 = 15'b111111111111111; //sfix15_En18
  parameter signed [14:0] coeff8 = 15'b111111111111001; //sfix15_En18
  parameter signed [14:0] coeff9 = 15'b111111111110010; //sfix15_En18
  parameter signed [14:0] coeff10 = 15'b111111111100111; //sfix15_En18
  parameter signed [14:0] coeff11 = 15'b111111111011010; //sfix15_En18
  parameter signed [14:0] coeff12 = 15'b111111111001001; //sfix15_En18
  parameter signed [14:0] coeff13 = 15'b111111110110100; //sfix15_En18
  parameter signed [14:0] coeff14 = 15'b111111110011011; //sfix15_En18
  parameter signed [14:0] coeff15 = 15'b111111101111110; //sfix15_En18
  parameter signed [14:0] coeff16 = 15'b111111101011101; //sfix15_En18
  parameter signed [14:0] coeff17 = 15'b111111100111001; //sfix15_En18
  parameter signed [14:0] coeff18 = 15'b111111100010010; //sfix15_En18
  parameter signed [14:0] coeff19 = 15'b111111011101000; //sfix15_En18
  parameter signed [14:0] coeff20 = 15'b111111010111101; //sfix15_En18
  parameter signed [14:0] coeff21 = 15'b111111010010011; //sfix15_En18
  parameter signed [14:0] coeff22 = 15'b111111001101010; //sfix15_En18
  parameter signed [14:0] coeff23 = 15'b111111001000100; //sfix15_En18
  parameter signed [14:0] coeff24 = 15'b111111000100100; //sfix15_En18
  parameter signed [14:0] coeff25 = 15'b111111000001101; //sfix15_En18
  parameter signed [14:0] coeff26 = 15'b111111000000000; //sfix15_En18
  parameter signed [14:0] coeff27 = 15'b111111000000001; //sfix15_En18
  parameter signed [14:0] coeff28 = 15'b111111000010010; //sfix15_En18
  parameter signed [14:0] coeff29 = 15'b111111000110111; //sfix15_En18
  parameter signed [14:0] coeff30 = 15'b111111001110011; //sfix15_En18
  parameter signed [14:0] coeff31 = 15'b111111011001000; //sfix15_En18
  parameter signed [14:0] coeff32 = 15'b111111100111001; //sfix15_En18
  parameter signed [14:0] coeff33 = 15'b111111111001001; //sfix15_En18
  parameter signed [14:0] coeff34 = 15'b000000001111010; //sfix15_En18
  parameter signed [14:0] coeff35 = 15'b000000101001101; //sfix15_En18
  parameter signed [14:0] coeff36 = 15'b000001001000101; //sfix15_En18
  parameter signed [14:0] coeff37 = 15'b000001101100001; //sfix15_En18
  parameter signed [14:0] coeff38 = 15'b000010010100010; //sfix15_En18
  parameter signed [14:0] coeff39 = 15'b000011000001000; //sfix15_En18
  parameter signed [14:0] coeff40 = 15'b000011110010000; //sfix15_En18
  parameter signed [14:0] coeff41 = 15'b000100100111000; //sfix15_En18
  parameter signed [14:0] coeff42 = 15'b000101011111111; //sfix15_En18
  parameter signed [14:0] coeff43 = 15'b000110011011111; //sfix15_En18
  parameter signed [14:0] coeff44 = 15'b000111011010110; //sfix15_En18
  parameter signed [14:0] coeff45 = 15'b001000011011101; //sfix15_En18
  parameter signed [14:0] coeff46 = 15'b001001011110000; //sfix15_En18
  parameter signed [14:0] coeff47 = 15'b001010100000111; //sfix15_En18
  parameter signed [14:0] coeff48 = 15'b001011100011101; //sfix15_En18
  parameter signed [14:0] coeff49 = 15'b001100100101011; //sfix15_En18
  parameter signed [14:0] coeff50 = 15'b001101100101001; //sfix15_En18
  parameter signed [14:0] coeff51 = 15'b001110100010010; //sfix15_En18
  parameter signed [14:0] coeff52 = 15'b001111011011100; //sfix15_En18
  parameter signed [14:0] coeff53 = 15'b010000010000011; //sfix15_En18
  parameter signed [14:0] coeff54 = 15'b010001000000000; //sfix15_En18
  parameter signed [14:0] coeff55 = 15'b010001101001101; //sfix15_En18
  parameter signed [14:0] coeff56 = 15'b010010001100100; //sfix15_En18
  parameter signed [14:0] coeff57 = 15'b010010101000011; //sfix15_En18
  parameter signed [14:0] coeff58 = 15'b010010111100100; //sfix15_En18
  parameter signed [14:0] coeff59 = 15'b010011001000110; //sfix15_En18
  ...
  reg  signed [36:0] acc_final; // sfix37_En32
  reg  signed [36:0] acc_out_1; // sfix37_En32
  wire signed [30:0] product_1; // sfix31_En32
  wire signed [14:0] product_1_mux; // sfix15_En18
  wire signed [36:0] prod_typeconvert_1; // sfix37_En32
  wire signed [36:0] acc_sum_1; // sfix37_En32
  wire signed [36:0] acc_in_1; // sfix37_En32
  wire signed [36:0] add_signext_2; // sfix37_En32
  wire signed [36:0] add_signext_3; // sfix37_En32
