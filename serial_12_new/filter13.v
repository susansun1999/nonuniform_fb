...
// Generated on: 2021-05-17 11:00:20
// -------------------------------------------------------------
...
////////////////////////////////////////////////////////////////
  ...
  // Type Definitions
  // Constants
  parameter signed [11:0] coeff1 = 12'b000000000001; //sfix12_En14
  ...
  parameter signed [11:0] coeff6 = 12'b111111111111; //sfix12_En14
  parameter signed [11:0] coeff7 = 12'b111111111101; //sfix12_En14
  parameter signed [11:0] coeff8 = 12'b000000000010; //sfix12_En14
  parameter signed [11:0] coeff9 = 12'b000000000100; //sfix12_En14
  parameter signed [11:0] coeff10 = 12'b111111111110; //sfix12_En14
  parameter signed [11:0] coeff11 = 12'b111111111101; //sfix12_En14
  parameter signed [11:0] coeff12 = 12'b000000000010; //sfix12_En14
  parameter signed [11:0] coeff13 = 12'b000000000010; //sfix12_En14
  parameter signed [11:0] coeff14 = 12'b000000000000; //sfix12_En14
  parameter signed [11:0] coeff15 = 12'b000000000001; //sfix12_En14
  parameter signed [11:0] coeff16 = 12'b111111111101; //sfix12_En14
  parameter signed [11:0] coeff17 = 12'b111111111001; //sfix12_En14
  parameter signed [11:0] coeff18 = 12'b000000001010; //sfix12_En14
  parameter signed [11:0] coeff19 = 12'b000000001111; //sfix12_En14
  parameter signed [11:0] coeff20 = 12'b111111101100; //sfix12_En14
  parameter signed [11:0] coeff21 = 12'b111111100111; //sfix12_En14
  parameter signed [11:0] coeff22 = 12'b000000100001; //sfix12_En14
  parameter signed [11:0] coeff23 = 12'b000000100101; //sfix12_En14
  parameter signed [11:0] coeff24 = 12'b111111001111; //sfix12_En14
  parameter signed [11:0] coeff25 = 12'b111111010001; //sfix12_En14
  parameter signed [11:0] coeff26 = 12'b000001000010; //sfix12_En14
  parameter signed [11:0] coeff27 = 12'b000000111000; //sfix12_En14
  parameter signed [11:0] coeff28 = 12'b111110101111; //sfix12_En14
  parameter signed [11:0] coeff29 = 12'b111111000100; //sfix12_En14
  parameter signed [11:0] coeff30 = 12'b000001011010; //sfix12_En14
  parameter signed [11:0] coeff31 = 12'b000000111010; //sfix12_En14
  parameter signed [11:0] coeff32 = 12'b111110101000; //sfix12_En14
  parameter signed [11:0] coeff33 = 12'b111111010000; //sfix12_En14
  parameter signed [11:0] coeff34 = 12'b000001000111; //sfix12_En14
  parameter signed [11:0] coeff35 = 12'b000000011101; //sfix12_En14
  parameter signed [11:0] coeff36 = 12'b111111011111; //sfix12_En14
  parameter signed [11:0] coeff37 = 12'b111111111110; //sfix12_En14
  parameter signed [11:0] coeff38 = 12'b111111100010; //sfix12_En14
  parameter signed [11:0] coeff39 = 12'b111111100000; //sfix12_En14
  parameter signed [11:0] coeff40 = 12'b000001111001; //sfix12_En14
  parameter signed [11:0] coeff41 = 12'b000001000101; //sfix12_En14
  parameter signed [11:0] coeff42 = 12'b111100010000; //sfix12_En14
  parameter signed [11:0] coeff43 = 12'b111110010101; //sfix12_En14
  parameter signed [11:0] coeff44 = 12'b000110000000; //sfix12_En14
  parameter signed [11:0] coeff45 = 12'b000010001101; //sfix12_En14
  parameter signed [11:0] coeff46 = 12'b110111011011; //sfix12_En14
  parameter signed [11:0] coeff47 = 12'b111101011010; //sfix12_En14
  parameter signed [11:0] coeff48 = 12'b001011010110; //sfix12_En14
  parameter signed [11:0] coeff49 = 12'b000010110011; //sfix12_En14
  parameter signed [11:0] coeff50 = 12'b110001110111; //sfix12_En14
  parameter signed [11:0] coeff51 = 12'b111101001111; //sfix12_En14
  parameter signed [11:0] coeff52 = 12'b010000110010; //sfix12_En14
  parameter signed [11:0] coeff53 = 12'b000010011111; //sfix12_En14
  parameter signed [11:0] coeff54 = 12'b101100111010; //sfix12_En14
  parameter signed [11:0] coeff55 = 12'b111110000010; //sfix12_En14
  parameter signed [11:0] coeff56 = 12'b010100111000; //sfix12_En14
  parameter signed [11:0] coeff57 = 12'b000001010001; //sfix12_En14
  parameter signed [11:0] coeff58 = 12'b101001111111; //sfix12_En14
  parameter signed [11:0] coeff59 = 12'b111111100100; //sfix12_En14
  parameter signed [11:0] coeff60 = 12'b010110011010; //sfix12_En14
  ...
  assign preaddmux_a1 = (cur_count == 6'b000000) ? delay_pipeline[0] :
                       ...
                       (cur_count == 6'b011001) ? delay_pipeline[27] :
  ...
  assign preaddmux_b1 = (cur_count == 6'b000000) ? delay_pipeline[118] :
                       ...
                       (cur_count == 6'b011001) ? delay_pipeline[91] :
