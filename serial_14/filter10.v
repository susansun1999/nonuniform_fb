...
// Generated on: 2021-05-07 09:25:20
// -------------------------------------------------------------
...
////////////////////////////////////////////////////////////////
  ...
  parameter signed [13:0] coeff2 = 14'b11111111110111; //sfix14_En16
  parameter signed [13:0] coeff3 = 14'b11111111110010; //sfix14_En16
  parameter signed [13:0] coeff4 = 14'b11111111111011; //sfix14_En16
  parameter signed [13:0] coeff5 = 14'b00000000010100; //sfix14_En16
  parameter signed [13:0] coeff6 = 14'b00000000100100; //sfix14_En16
  parameter signed [13:0] coeff7 = 14'b00000000010010; //sfix14_En16
  parameter signed [13:0] coeff8 = 14'b11111111100001; //sfix14_En16
  parameter signed [13:0] coeff9 = 14'b11111110111011; //sfix14_En16
  parameter signed [13:0] coeff10 = 14'b11111111010011; //sfix14_En16
  parameter signed [13:0] coeff11 = 14'b00000000100101; //sfix14_En16
  parameter signed [13:0] coeff12 = 14'b00000001101100; //sfix14_En16
  parameter signed [13:0] coeff13 = 14'b00000001010111; //sfix14_En16
  parameter signed [13:0] coeff14 = 14'b11111111100011; //sfix14_En16
  parameter signed [13:0] coeff15 = 14'b11111101110010; //sfix14_En16
  parameter signed [13:0] coeff16 = 14'b11111101111001; //sfix14_En16
  parameter signed [13:0] coeff17 = 14'b00000000000101; //sfix14_En16
  parameter signed [13:0] coeff18 = 14'b00000010011101; //sfix14_En16
  parameter signed [13:0] coeff19 = 14'b00000010101110; //sfix14_En16
  parameter signed [13:0] coeff20 = 14'b00000000011110; //sfix14_En16
  parameter signed [13:0] coeff21 = 14'b11111101110010; //sfix14_En16
  parameter signed [13:0] coeff22 = 14'b11111101001011; //sfix14_En16
  parameter signed [13:0] coeff23 = 14'b11111111000110; //sfix14_En16
  parameter signed [13:0] coeff24 = 14'b00000001011101; //sfix14_En16
  parameter signed [13:0] coeff25 = 14'b00000010000001; //sfix14_En16
  parameter signed [13:0] coeff26 = 14'b00000000110000; //sfix14_En16
  parameter signed [13:0] coeff27 = 14'b11111111101001; //sfix14_En16
  parameter signed [13:0] coeff28 = 14'b00000000000000; //sfix14_En16
  parameter signed [13:0] coeff29 = 14'b00000000101000; //sfix14_En16
  parameter signed [13:0] coeff30 = 14'b11111111011100; //sfix14_En16
  parameter signed [13:0] coeff31 = 14'b11111100110010; //sfix14_En16
  parameter signed [13:0] coeff32 = 14'b11111100001110; //sfix14_En16
  parameter signed [13:0] coeff33 = 14'b00000000100101; //sfix14_En16
  parameter signed [13:0] coeff34 = 14'b00000111010010; //sfix14_En16
  parameter signed [13:0] coeff35 = 14'b00001001000010; //sfix14_En16
  parameter signed [13:0] coeff36 = 14'b00000001001010; //sfix14_En16
  parameter signed [13:0] coeff37 = 14'b11110100100111; //sfix14_En16
  parameter signed [13:0] coeff38 = 14'b11101111110000; //sfix14_En16
  parameter signed [13:0] coeff39 = 14'b11111010100111; //sfix14_En16
  parameter signed [13:0] coeff40 = 14'b00001110011101; //sfix14_En16
  parameter signed [13:0] coeff41 = 14'b00011000110101; //sfix14_En16
  parameter signed [13:0] coeff42 = 14'b00001100011100; //sfix14_En16
  parameter signed [13:0] coeff43 = 14'b11110000101011; //sfix14_En16
  parameter signed [13:0] coeff44 = 14'b11011110011011; //sfix14_En16
  parameter signed [13:0] coeff45 = 14'b11101001111100; //sfix14_En16
  parameter signed [13:0] coeff46 = 14'b00001101000101; //sfix14_En16
  parameter signed [13:0] coeff47 = 14'b00101001000010; //sfix14_En16
  parameter signed [13:0] coeff48 = 14'b00100001010111; //sfix14_En16
  parameter signed [13:0] coeff49 = 14'b11111000101110; //sfix14_En16
  parameter signed [13:0] coeff50 = 14'b11010010010011; //sfix14_En16
  parameter signed [13:0] coeff51 = 14'b11010011001001; //sfix14_En16
  parameter signed [13:0] coeff52 = 14'b11111110010010; //sfix14_En16
  parameter signed [13:0] coeff53 = 14'b00101110011111; //sfix14_En16
  parameter signed [13:0] coeff54 = 14'b00110110110101; //sfix14_En16
  parameter signed [13:0] coeff55 = 14'b00001100111100; //sfix14_En16
  parameter signed [13:0] coeff56 = 14'b11010101000111; //sfix14_En16
  parameter signed [13:0] coeff57 = 14'b11000010011010; //sfix14_En16
  parameter signed [13:0] coeff58 = 14'b11100111010010; //sfix14_En16
  parameter signed [13:0] coeff59 = 14'b00100011010001; //sfix14_En16
