...
// Generated on: 2021-05-07 09:25:07
// -------------------------------------------------------------
...
////////////////////////////////////////////////////////////////
  ...
  // Type Definitions
  // Constants
  parameter signed [13:0] coeff1 = 14'b11111111111010; //sfix14_En16
  parameter signed [13:0] coeff2 = 14'b11111111110110; //sfix14_En16
  parameter signed [13:0] coeff3 = 14'b11111111110100; //sfix14_En16
  parameter signed [13:0] coeff4 = 14'b11111111111000; //sfix14_En16
  parameter signed [13:0] coeff5 = 14'b00000000000100; //sfix14_En16
  parameter signed [13:0] coeff6 = 14'b00000000010111; //sfix14_En16
  parameter signed [13:0] coeff7 = 14'b00000000101011; //sfix14_En16
  parameter signed [13:0] coeff8 = 14'b00000000111000; //sfix14_En16
  parameter signed [13:0] coeff9 = 14'b00000000110011; //sfix14_En16
  parameter signed [13:0] coeff10 = 14'b00000000011000; //sfix14_En16
  parameter signed [13:0] coeff11 = 14'b11111111101001; //sfix14_En16
  parameter signed [13:0] coeff12 = 14'b11111110110011; //sfix14_En16
  parameter signed [13:0] coeff13 = 14'b11111110001000; //sfix14_En16
  parameter signed [13:0] coeff14 = 14'b11111101111100; //sfix14_En16
  parameter signed [13:0] coeff15 = 14'b11111110011010; //sfix14_En16
  parameter signed [13:0] coeff16 = 14'b11111111100000; //sfix14_En16
  parameter signed [13:0] coeff17 = 14'b00000000111011; //sfix14_En16
  parameter signed [13:0] coeff18 = 14'b00000010001111; //sfix14_En16
  parameter signed [13:0] coeff19 = 14'b00000010111110; //sfix14_En16
  parameter signed [13:0] coeff20 = 14'b00000010110100; //sfix14_En16
  parameter signed [13:0] coeff21 = 14'b00000001110011; //sfix14_En16
  parameter signed [13:0] coeff22 = 14'b00000000010010; //sfix14_En16
  parameter signed [13:0] coeff23 = 14'b11111110110110; //sfix14_En16
  parameter signed [13:0] coeff24 = 14'b11111101111111; //sfix14_En16
  parameter signed [13:0] coeff25 = 14'b11111101111111; //sfix14_En16
  parameter signed [13:0] coeff26 = 14'b11111110101100; //sfix14_En16
  parameter signed [13:0] coeff27 = 14'b11111111100101; //sfix14_En16
  parameter signed [13:0] coeff28 = 14'b00000000000000; //sfix14_En16
  parameter signed [13:0] coeff29 = 14'b11111111100000; //sfix14_En16
  parameter signed [13:0] coeff30 = 14'b11111110001010; //sfix14_En16
  parameter signed [13:0] coeff31 = 14'b11111100101000; //sfix14_En16
  parameter signed [13:0] coeff32 = 14'b11111011111110; //sfix14_En16
  parameter signed [13:0] coeff33 = 14'b11111101001111; //sfix14_En16
  parameter signed [13:0] coeff34 = 14'b00000000110100; //sfix14_En16
  parameter signed [13:0] coeff35 = 14'b00000110000110; //sfix14_En16
  parameter signed [13:0] coeff36 = 14'b00001011011011; //sfix14_En16
  parameter signed [13:0] coeff37 = 14'b00001110011110; //sfix14_En16
  parameter signed [13:0] coeff38 = 14'b00001101001100; //sfix14_En16
  parameter signed [13:0] coeff39 = 14'b00000110100111; //sfix14_En16
  parameter signed [13:0] coeff40 = 14'b11111011101010; //sfix14_En16
  parameter signed [13:0] coeff41 = 14'b11101111001101; //sfix14_En16
  parameter signed [13:0] coeff42 = 14'b11100101010111; //sfix14_En16
  parameter signed [13:0] coeff43 = 14'b11100010001101; //sfix14_En16
  parameter signed [13:0] coeff44 = 14'b11101000001110; //sfix14_En16
  parameter signed [13:0] coeff45 = 14'b11110111000111; //sfix14_En16
  parameter signed [13:0] coeff46 = 14'b00001011011101; //sfix14_En16
  parameter signed [13:0] coeff47 = 14'b00011111010111; //sfix14_En16
  parameter signed [13:0] coeff48 = 14'b00101100001111; //sfix14_En16
  parameter signed [13:0] coeff49 = 14'b00101100111111; //sfix14_En16
  parameter signed [13:0] coeff50 = 14'b00011111111100; //sfix14_En16
  parameter signed [13:0] coeff51 = 14'b00000111101111; //sfix14_En16
  parameter signed [13:0] coeff52 = 14'b11101010111110; //sfix14_En16
  parameter signed [13:0] coeff53 = 14'b11010010001111; //sfix14_En16
  parameter signed [13:0] coeff54 = 14'b11000101100000; //sfix14_En16
  parameter signed [13:0] coeff55 = 14'b11001001011101; //sfix14_En16
  parameter signed [13:0] coeff56 = 14'b11011101110000; //sfix14_En16
  parameter signed [13:0] coeff57 = 14'b11111100111011; //sfix14_En16
  parameter signed [13:0] coeff58 = 14'b00011101111001; //sfix14_En16
  parameter signed [13:0] coeff59 = 14'b00110110110001; //sfix14_En16
