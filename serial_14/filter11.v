...
// Generated on: 2021-05-07 09:25:23
// -------------------------------------------------------------
...
////////////////////////////////////////////////////////////////
  ...
  // Type Definitions
  // Constants
  parameter signed [13:0] coeff1 = 14'b11111111111110; //sfix14_En16
  parameter signed [13:0] coeff2 = 14'b00000000001000; //sfix14_En16
  parameter signed [13:0] coeff3 = 14'b00000000001101; //sfix14_En16
  parameter signed [13:0] coeff4 = 14'b11111111111110; //sfix14_En16
  parameter signed [13:0] coeff5 = 14'b11111111100101; //sfix14_En16
  parameter signed [13:0] coeff6 = 14'b11111111100111; //sfix14_En16
  parameter signed [13:0] coeff7 = 14'b00000000010001; //sfix14_En16
  parameter signed [13:0] coeff8 = 14'b00000000111001; //sfix14_En16
  parameter signed [13:0] coeff9 = 14'b00000000011111; //sfix14_En16
  parameter signed [13:0] coeff10 = 14'b11111111001100; //sfix14_En16
  parameter signed [13:0] coeff11 = 14'b11111110100100; //sfix14_En16
  parameter signed [13:0] coeff12 = 14'b11111111101111; //sfix14_En16
  parameter signed [13:0] coeff13 = 14'b00000001101000; //sfix14_En16
  parameter signed [13:0] coeff14 = 14'b00000001110101; //sfix14_En16
  parameter signed [13:0] coeff15 = 14'b11111111101010; //sfix14_En16
  parameter signed [13:0] coeff16 = 14'b11111101100001; //sfix14_En16
  parameter signed [13:0] coeff17 = 14'b11111110001111; //sfix14_En16
  parameter signed [13:0] coeff18 = 14'b00000001010001; //sfix14_En16
  parameter signed [13:0] coeff19 = 14'b00000011000000; //sfix14_En16
  parameter signed [13:0] coeff20 = 14'b00000001001010; //sfix14_En16
  parameter signed [13:0] coeff21 = 14'b11111101111100; //sfix14_En16
  parameter signed [13:0] coeff22 = 14'b11111101010000; //sfix14_En16
  parameter signed [13:0] coeff23 = 14'b11111111110001; //sfix14_En16
  parameter signed [13:0] coeff24 = 14'b00000010000111; //sfix14_En16
  parameter signed [13:0] coeff25 = 14'b00000001101000; //sfix14_En16
  parameter signed [13:0] coeff26 = 14'b11111111101100; //sfix14_En16
  parameter signed [13:0] coeff27 = 14'b11111111001101; //sfix14_En16
  parameter signed [13:0] coeff28 = 14'b00000000000000; //sfix14_En16
  parameter signed [13:0] coeff29 = 14'b11111111100001; //sfix14_En16
  parameter signed [13:0] coeff30 = 14'b11111101111011; //sfix14_En16
  parameter signed [13:0] coeff31 = 14'b11111110111011; //sfix14_En16
  parameter signed [13:0] coeff32 = 14'b00000011100100; //sfix14_En16
  parameter signed [13:0] coeff33 = 14'b00000101111101; //sfix14_En16
  parameter signed [13:0] coeff34 = 14'b00000000001010; //sfix14_En16
  parameter signed [13:0] coeff35 = 14'b11110110110000; //sfix14_En16
  parameter signed [13:0] coeff36 = 14'b11110110100111; //sfix14_En16
  parameter signed [13:0] coeff37 = 14'b00000100000111; //sfix14_En16
  parameter signed [13:0] coeff38 = 14'b00010000111001; //sfix14_En16
  parameter signed [13:0] coeff39 = 14'b00001010011010; //sfix14_En16
  parameter signed [13:0] coeff40 = 14'b11110011101001; //sfix14_En16
  parameter signed [13:0] coeff41 = 14'b11100111010110; //sfix14_En16
  parameter signed [13:0] coeff42 = 14'b11111000111110; //sfix14_En16
  parameter signed [13:0] coeff43 = 14'b00010111111100; //sfix14_En16
  parameter signed [13:0] coeff44 = 14'b00011101111110; //sfix14_En16
  parameter signed [13:0] coeff45 = 14'b11111110001101; //sfix14_En16
  parameter signed [13:0] coeff46 = 14'b11011011010000; //sfix14_En16
  parameter signed [13:0] coeff47 = 14'b11100001110010; //sfix14_En16
  parameter signed [13:0] coeff48 = 14'b00001111100111; //sfix14_En16
  parameter signed [13:0] coeff49 = 14'b00101111101011; //sfix14_En16
  parameter signed [13:0] coeff50 = 14'b00010111101110; //sfix14_En16
  parameter signed [13:0] coeff51 = 14'b11011111110001; //sfix14_En16
  parameter signed [13:0] coeff52 = 14'b11001010100100; //sfix14_En16
  parameter signed [13:0] coeff53 = 14'b11110101011100; //sfix14_En16
  parameter signed [13:0] coeff54 = 14'b00110000001110; //sfix14_En16
  parameter signed [13:0] coeff55 = 14'b00110011110000; //sfix14_En16
  parameter signed [13:0] coeff56 = 14'b11111000110000; //sfix14_En16
  parameter signed [13:0] coeff57 = 14'b11000100001110; //sfix14_En16
  parameter signed [13:0] coeff58 = 14'b11010101111001; //sfix14_En16
