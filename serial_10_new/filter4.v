...
// Generated on: 2021-05-17 13:54:13
// -------------------------------------------------------------
...
////////////////////////////////////////////////////////////////
  ...
  parameter signed [9:0] coeff15 = 10'b1111111110; //sfix10_En12
  ...
  parameter signed [9:0] coeff20 = 10'b1111111010; //sfix10_En12
  ...
  parameter signed [9:0] coeff24 = 10'b0000000000; //sfix10_En12
  parameter signed [9:0] coeff25 = 10'b0000000010; //sfix10_En12
  ...
  parameter signed [9:0] coeff29 = 10'b1111111101; //sfix10_En12
  parameter signed [9:0] coeff30 = 10'b1111111010; //sfix10_En12
  parameter signed [9:0] coeff31 = 10'b1111111000; //sfix10_En12
  parameter signed [9:0] coeff32 = 10'b1111110111; //sfix10_En12
  parameter signed [9:0] coeff33 = 10'b1111111001; //sfix10_En12
  parameter signed [9:0] coeff34 = 10'b1111111111; //sfix10_En12
  parameter signed [9:0] coeff35 = 10'b0000001001; //sfix10_En12
  parameter signed [9:0] coeff36 = 10'b0000010111; //sfix10_En12
  parameter signed [9:0] coeff37 = 10'b0000100110; //sfix10_En12
  parameter signed [9:0] coeff38 = 10'b0000110111; //sfix10_En12
  parameter signed [9:0] coeff39 = 10'b0001000100; //sfix10_En12
  parameter signed [9:0] coeff40 = 10'b0001001101; //sfix10_En12
  parameter signed [9:0] coeff41 = 10'b0001001110; //sfix10_En12
  parameter signed [9:0] coeff42 = 10'b0001000101; //sfix10_En12
  parameter signed [9:0] coeff43 = 10'b0000110001; //sfix10_En12
  parameter signed [9:0] coeff44 = 10'b0000010010; //sfix10_En12
  parameter signed [9:0] coeff45 = 10'b1111101010; //sfix10_En12
  parameter signed [9:0] coeff46 = 10'b1110111101; //sfix10_En12
  parameter signed [9:0] coeff47 = 10'b1110010000; //sfix10_En12
  parameter signed [9:0] coeff48 = 10'b1101101000; //sfix10_En12
  parameter signed [9:0] coeff49 = 10'b1101001011; //sfix10_En12
  parameter signed [9:0] coeff50 = 10'b1100111110; //sfix10_En12
  parameter signed [9:0] coeff51 = 10'b1101000011; //sfix10_En12
  parameter signed [9:0] coeff52 = 10'b1101011101; //sfix10_En12
  parameter signed [9:0] coeff53 = 10'b1110001010; //sfix10_En12
  parameter signed [9:0] coeff54 = 10'b1111000111; //sfix10_En12
  parameter signed [9:0] coeff55 = 10'b0000001101; //sfix10_En12
  parameter signed [9:0] coeff56 = 10'b0001010110; //sfix10_En12
  parameter signed [9:0] coeff57 = 10'b0010011001; //sfix10_En12
  parameter signed [9:0] coeff58 = 10'b0011010000; //sfix10_En12
  parameter signed [9:0] coeff59 = 10'b0011110100; //sfix10_En12
