...
// Generated on: 2021-05-17 13:54:30
// -------------------------------------------------------------
...
////////////////////////////////////////////////////////////////
  ...
  parameter signed [9:0] coeff31 = 10'b1111111101; //sfix10_En12
  parameter signed [9:0] coeff32 = 10'b0000001011; //sfix10_En12
  parameter signed [9:0] coeff33 = 10'b0000010011; //sfix10_En12
  parameter signed [9:0] coeff34 = 10'b0000000001; //sfix10_En12
  parameter signed [9:0] coeff35 = 10'b1111100001; //sfix10_En12
  parameter signed [9:0] coeff36 = 10'b1111100000; //sfix10_En12
  parameter signed [9:0] coeff37 = 10'b0000001110; //sfix10_En12
  parameter signed [9:0] coeff38 = 10'b0000111010; //sfix10_En12
  parameter signed [9:0] coeff39 = 10'b0000100100; //sfix10_En12
  parameter signed [9:0] coeff40 = 10'b1111010100; //sfix10_En12
  parameter signed [9:0] coeff41 = 10'b1110100111; //sfix10_En12
  parameter signed [9:0] coeff42 = 10'b1111100110; //sfix10_En12
  parameter signed [9:0] coeff43 = 10'b0001011000; //sfix10_En12
  parameter signed [9:0] coeff44 = 10'b0001101111; //sfix10_En12
  parameter signed [9:0] coeff45 = 10'b1111111001; //sfix10_En12
  parameter signed [9:0] coeff46 = 10'b1101110101; //sfix10_En12
  parameter signed [9:0] coeff47 = 10'b1110001101; //sfix10_En12
  parameter signed [9:0] coeff48 = 10'b0000111100; //sfix10_En12
  parameter signed [9:0] coeff49 = 10'b0010111000; //sfix10_En12
  parameter signed [9:0] coeff50 = 10'b0001011100; //sfix10_En12
  parameter signed [9:0] coeff51 = 10'b1110000010; //sfix10_En12
  parameter signed [9:0] coeff52 = 10'b1100101110; //sfix10_En12
  parameter signed [9:0] coeff53 = 10'b1111010110; //sfix10_En12
  parameter signed [9:0] coeff54 = 10'b0010111111; //sfix10_En12
  parameter signed [9:0] coeff55 = 10'b0011001110; //sfix10_En12
  parameter signed [9:0] coeff56 = 10'b1111100011; //sfix10_En12
  parameter signed [9:0] coeff57 = 10'b1100010001; //sfix10_En12
  parameter signed [9:0] coeff58 = 10'b1101011000; //sfix10_En12
  parameter signed [9:0] coeff59 = 10'b0001101001; //sfix10_En12
