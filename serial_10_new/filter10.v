...
// Generated on: 2021-05-17 13:54:28
// -------------------------------------------------------------
...
////////////////////////////////////////////////////////////////
  ...
  parameter signed [9:0] coeff6 = 10'b0000000001; //sfix10_En12
  parameter signed [9:0] coeff7 = 10'b0000000000; //sfix10_En12
  parameter signed [9:0] coeff8 = 10'b1111111111; //sfix10_En12
  parameter signed [9:0] coeff9 = 10'b1111111110; //sfix10_En12
  ...
  parameter signed [9:0] coeff17 = 10'b0000000000; //sfix10_En12
  parameter signed [9:0] coeff18 = 10'b0000000101; //sfix10_En12
  parameter signed [9:0] coeff19 = 10'b0000000110; //sfix10_En12
  ...
  parameter signed [9:0] coeff23 = 10'b1111111110; //sfix10_En12
  parameter signed [9:0] coeff24 = 10'b0000000100; //sfix10_En12
  parameter signed [9:0] coeff25 = 10'b0000000101; //sfix10_En12
  ...
  parameter signed [9:0] coeff30 = 10'b1111111110; //sfix10_En12
  ...
  parameter signed [9:0] coeff34 = 10'b0000011000; //sfix10_En12
  parameter signed [9:0] coeff35 = 10'b0000011110; //sfix10_En12
  parameter signed [9:0] coeff36 = 10'b0000000100; //sfix10_En12
  parameter signed [9:0] coeff37 = 10'b1111011001; //sfix10_En12
  parameter signed [9:0] coeff38 = 10'b1111001000; //sfix10_En12
  parameter signed [9:0] coeff39 = 10'b1111101101; //sfix10_En12
  parameter signed [9:0] coeff40 = 10'b0000110011; //sfix10_En12
  parameter signed [9:0] coeff41 = 10'b0001011001; //sfix10_En12
  parameter signed [9:0] coeff42 = 10'b0000101101; //sfix10_En12
  parameter signed [9:0] coeff43 = 10'b1111001000; //sfix10_En12
  parameter signed [9:0] coeff44 = 10'b1110000011; //sfix10_En12
  parameter signed [9:0] coeff45 = 10'b1110101101; //sfix10_En12
  parameter signed [9:0] coeff46 = 10'b0000110001; //sfix10_En12
  parameter signed [9:0] coeff47 = 10'b0010011100; //sfix10_En12
  parameter signed [9:0] coeff48 = 10'b0010000000; //sfix10_En12
  parameter signed [9:0] coeff49 = 10'b1111100100; //sfix10_En12
  parameter signed [9:0] coeff50 = 10'b1101001110; //sfix10_En12
  parameter signed [9:0] coeff51 = 10'b1101010001; //sfix10_En12
  parameter signed [9:0] coeff52 = 10'b1111111001; //sfix10_En12
  parameter signed [9:0] coeff53 = 10'b0010110111; //sfix10_En12
  parameter signed [9:0] coeff54 = 10'b0011011001; //sfix10_En12
  parameter signed [9:0] coeff55 = 10'b0000110011; //sfix10_En12
  parameter signed [9:0] coeff56 = 10'b1101010101; //sfix10_En12
  parameter signed [9:0] coeff57 = 10'b1100001010; //sfix10_En12
  parameter signed [9:0] coeff58 = 10'b1110011101; //sfix10_En12
  parameter signed [9:0] coeff59 = 10'b0010001101; //sfix10_En12
