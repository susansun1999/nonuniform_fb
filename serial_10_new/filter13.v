...
// Generated on: 2021-05-17 13:54:35
// -------------------------------------------------------------
...
////////////////////////////////////////////////////////////////
  ...
  parameter signed [9:0] coeff5 = 10'b0000000001; //sfix10_En12
  parameter signed [9:0] coeff6 = 10'b0000000000; //sfix10_En12
  parameter signed [9:0] coeff7 = 10'b1111111111; //sfix10_En12
  ...
  parameter signed [9:0] coeff12 = 10'b0000000001; //sfix10_En12
  parameter signed [9:0] coeff13 = 10'b0000000000; //sfix10_En12
  parameter signed [9:0] coeff14 = 10'b0000000000; //sfix10_En12
  parameter signed [9:0] coeff15 = 10'b0000000000; //sfix10_En12
  parameter signed [9:0] coeff16 = 10'b1111111111; //sfix10_En12
  parameter signed [9:0] coeff17 = 10'b1111111110; //sfix10_En12
  parameter signed [9:0] coeff18 = 10'b0000000011; //sfix10_En12
  parameter signed [9:0] coeff19 = 10'b0000000100; //sfix10_En12
  parameter signed [9:0] coeff20 = 10'b1111111011; //sfix10_En12
  parameter signed [9:0] coeff21 = 10'b1111111010; //sfix10_En12
  parameter signed [9:0] coeff22 = 10'b0000001000; //sfix10_En12
  parameter signed [9:0] coeff23 = 10'b0000001001; //sfix10_En12
  parameter signed [9:0] coeff24 = 10'b1111110100; //sfix10_En12
  parameter signed [9:0] coeff25 = 10'b1111110100; //sfix10_En12
  parameter signed [9:0] coeff26 = 10'b0000010001; //sfix10_En12
  parameter signed [9:0] coeff27 = 10'b0000001110; //sfix10_En12
  parameter signed [9:0] coeff28 = 10'b1111101100; //sfix10_En12
  parameter signed [9:0] coeff29 = 10'b1111110001; //sfix10_En12
  parameter signed [9:0] coeff30 = 10'b0000010110; //sfix10_En12
  parameter signed [9:0] coeff31 = 10'b0000001110; //sfix10_En12
  parameter signed [9:0] coeff32 = 10'b1111101010; //sfix10_En12
  parameter signed [9:0] coeff33 = 10'b1111110100; //sfix10_En12
  parameter signed [9:0] coeff34 = 10'b0000010010; //sfix10_En12
  parameter signed [9:0] coeff35 = 10'b0000000111; //sfix10_En12
  parameter signed [9:0] coeff36 = 10'b1111111000; //sfix10_En12
  parameter signed [9:0] coeff37 = 10'b1111111111; //sfix10_En12
  parameter signed [9:0] coeff38 = 10'b1111111000; //sfix10_En12
  parameter signed [9:0] coeff39 = 10'b1111111000; //sfix10_En12
  parameter signed [9:0] coeff40 = 10'b0000011110; //sfix10_En12
  parameter signed [9:0] coeff41 = 10'b0000010001; //sfix10_En12
  parameter signed [9:0] coeff42 = 10'b1111000100; //sfix10_En12
  parameter signed [9:0] coeff43 = 10'b1111100101; //sfix10_En12
  parameter signed [9:0] coeff44 = 10'b0001100000; //sfix10_En12
  parameter signed [9:0] coeff45 = 10'b0000100011; //sfix10_En12
  parameter signed [9:0] coeff46 = 10'b1101110111; //sfix10_En12
  parameter signed [9:0] coeff47 = 10'b1111010110; //sfix10_En12
  parameter signed [9:0] coeff48 = 10'b0010110101; //sfix10_En12
  parameter signed [9:0] coeff49 = 10'b0000101101; //sfix10_En12
  parameter signed [9:0] coeff50 = 10'b1100011110; //sfix10_En12
  parameter signed [9:0] coeff51 = 10'b1111010100; //sfix10_En12
  parameter signed [9:0] coeff52 = 10'b0100001101; //sfix10_En12
  parameter signed [9:0] coeff53 = 10'b0000101000; //sfix10_En12
  parameter signed [9:0] coeff54 = 10'b1011001111; //sfix10_En12
  parameter signed [9:0] coeff55 = 10'b1111100000; //sfix10_En12
  parameter signed [9:0] coeff56 = 10'b0101001110; //sfix10_En12
  parameter signed [9:0] coeff57 = 10'b0000010100; //sfix10_En12
  parameter signed [9:0] coeff58 = 10'b1010100000; //sfix10_En12
  parameter signed [9:0] coeff59 = 10'b1111111001; //sfix10_En12
  parameter signed [9:0] coeff60 = 10'b0101100110; //sfix10_En12
