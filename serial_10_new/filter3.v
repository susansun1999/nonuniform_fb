...
// Generated on: 2021-05-17 13:54:10
// -------------------------------------------------------------
...
////////////////////////////////////////////////////////////////
  ...
  parameter signed [9:0] coeff15 = 10'b0000000100; //sfix10_En12
  parameter signed [9:0] coeff16 = 10'b0000000100; //sfix10_En12
  parameter signed [9:0] coeff17 = 10'b0000000100; //sfix10_En12
  parameter signed [9:0] coeff18 = 10'b0000000100; //sfix10_En12
  parameter signed [9:0] coeff19 = 10'b0000000011; //sfix10_En12
  parameter signed [9:0] coeff20 = 10'b0000000001; //sfix10_En12
  parameter signed [9:0] coeff21 = 10'b0000000000; //sfix10_En12
  parameter signed [9:0] coeff22 = 10'b1111111111; //sfix10_En12
  parameter signed [9:0] coeff23 = 10'b1111111101; //sfix10_En12
  parameter signed [9:0] coeff24 = 10'b1111111100; //sfix10_En12
  parameter signed [9:0] coeff25 = 10'b1111111100; //sfix10_En12
  parameter signed [9:0] coeff26 = 10'b1111111101; //sfix10_En12
  parameter signed [9:0] coeff27 = 10'b1111111110; //sfix10_En12
  parameter signed [9:0] coeff28 = 10'b0000000000; //sfix10_En12
  parameter signed [9:0] coeff29 = 10'b0000000011; //sfix10_En12
  parameter signed [9:0] coeff30 = 10'b0000000110; //sfix10_En12
  parameter signed [9:0] coeff31 = 10'b0000001001; //sfix10_En12
  parameter signed [9:0] coeff32 = 10'b0000001100; //sfix10_En12
  parameter signed [9:0] coeff33 = 10'b0000001110; //sfix10_En12
  parameter signed [9:0] coeff34 = 10'b0000001101; //sfix10_En12
  parameter signed [9:0] coeff35 = 10'b0000001011; //sfix10_En12
  parameter signed [9:0] coeff36 = 10'b0000000101; //sfix10_En12
  parameter signed [9:0] coeff37 = 10'b1111111100; //sfix10_En12
  parameter signed [9:0] coeff38 = 10'b1111101111; //sfix10_En12
  parameter signed [9:0] coeff39 = 10'b1111100000; //sfix10_En12
  parameter signed [9:0] coeff40 = 10'b1111001110; //sfix10_En12
  parameter signed [9:0] coeff41 = 10'b1110111010; //sfix10_En12
  parameter signed [9:0] coeff42 = 10'b1110100110; //sfix10_En12
  parameter signed [9:0] coeff43 = 10'b1110010100; //sfix10_En12
  parameter signed [9:0] coeff44 = 10'b1110000100; //sfix10_En12
  parameter signed [9:0] coeff45 = 10'b1101111000; //sfix10_En12
  parameter signed [9:0] coeff46 = 10'b1101110011; //sfix10_En12
  parameter signed [9:0] coeff47 = 10'b1101110101; //sfix10_En12
  parameter signed [9:0] coeff48 = 10'b1101111111; //sfix10_En12
  parameter signed [9:0] coeff49 = 10'b1110010001; //sfix10_En12
  parameter signed [9:0] coeff50 = 10'b1110101100; //sfix10_En12
  parameter signed [9:0] coeff51 = 10'b1111001111; //sfix10_En12
  parameter signed [9:0] coeff52 = 10'b1111111000; //sfix10_En12
  parameter signed [9:0] coeff53 = 10'b0000100100; //sfix10_En12
  parameter signed [9:0] coeff54 = 10'b0001010011; //sfix10_En12
  parameter signed [9:0] coeff55 = 10'b0010000000; //sfix10_En12
  parameter signed [9:0] coeff56 = 10'b0010101010; //sfix10_En12
  parameter signed [9:0] coeff57 = 10'b0011001110; //sfix10_En12
  parameter signed [9:0] coeff58 = 10'b0011101001; //sfix10_En12
  parameter signed [9:0] coeff59 = 10'b0011111010; //sfix10_En12
