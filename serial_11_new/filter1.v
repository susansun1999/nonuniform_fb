...
// Generated on: 2021-05-17 12:09:06
// -------------------------------------------------------------
...
// Arithmetic        : fixed
// Numerator         : s11,14 -> [-6.250000e-02 6.250000e-02)
// -------------------------------------------------------------
// Multipliers           : 1
...
module filter1
  ...
  output  signed [28:0] filter_out; //sfix29_En24
...
////////////////////////////////////////////////////////////////
  ...
  // Type Definitions
  // Constants
  parameter signed [10:0] coeff1 = 11'b00000000000; //sfix11_En14
  parameter signed [10:0] coeff2 = 11'b00000000000; //sfix11_En14
  parameter signed [10:0] coeff3 = 11'b00000000000; //sfix11_En14
  parameter signed [10:0] coeff4 = 11'b00000000000; //sfix11_En14
  parameter signed [10:0] coeff5 = 11'b00000000000; //sfix11_En14
  parameter signed [10:0] coeff6 = 11'b00000000000; //sfix11_En14
  parameter signed [10:0] coeff7 = 11'b00000000000; //sfix11_En14
  parameter signed [10:0] coeff8 = 11'b00000000000; //sfix11_En14
  parameter signed [10:0] coeff9 = 11'b11111111111; //sfix11_En14
  parameter signed [10:0] coeff10 = 11'b11111111110; //sfix11_En14
  parameter signed [10:0] coeff11 = 11'b11111111110; //sfix11_En14
  parameter signed [10:0] coeff12 = 11'b11111111101; //sfix11_En14
  parameter signed [10:0] coeff13 = 11'b11111111011; //sfix11_En14
  parameter signed [10:0] coeff14 = 11'b11111111010; //sfix11_En14
  parameter signed [10:0] coeff15 = 11'b11111111000; //sfix11_En14
  parameter signed [10:0] coeff16 = 11'b11111110110; //sfix11_En14
  parameter signed [10:0] coeff17 = 11'b11111110100; //sfix11_En14
  parameter signed [10:0] coeff18 = 11'b11111110001; //sfix11_En14
  parameter signed [10:0] coeff19 = 11'b11111101111; //sfix11_En14
  parameter signed [10:0] coeff20 = 11'b11111101100; //sfix11_En14
  parameter signed [10:0] coeff21 = 11'b11111101001; //sfix11_En14
  parameter signed [10:0] coeff22 = 11'b11111100111; //sfix11_En14
  parameter signed [10:0] coeff23 = 11'b11111100100; //sfix11_En14
  parameter signed [10:0] coeff24 = 11'b11111100010; //sfix11_En14
  parameter signed [10:0] coeff25 = 11'b11111100001; //sfix11_En14
  parameter signed [10:0] coeff26 = 11'b11111100000; //sfix11_En14
  parameter signed [10:0] coeff27 = 11'b11111100000; //sfix11_En14
  parameter signed [10:0] coeff28 = 11'b11111100001; //sfix11_En14
  parameter signed [10:0] coeff29 = 11'b11111100011; //sfix11_En14
  parameter signed [10:0] coeff30 = 11'b11111100111; //sfix11_En14
  parameter signed [10:0] coeff31 = 11'b11111101100; //sfix11_En14
  parameter signed [10:0] coeff32 = 11'b11111110100; //sfix11_En14
  parameter signed [10:0] coeff33 = 11'b11111111101; //sfix11_En14
  parameter signed [10:0] coeff34 = 11'b00000001000; //sfix11_En14
  parameter signed [10:0] coeff35 = 11'b00000010101; //sfix11_En14
  parameter signed [10:0] coeff36 = 11'b00000100100; //sfix11_En14
  parameter signed [10:0] coeff37 = 11'b00000110110; //sfix11_En14
  parameter signed [10:0] coeff38 = 11'b00001001010; //sfix11_En14
  parameter signed [10:0] coeff39 = 11'b00001100000; //sfix11_En14
  parameter signed [10:0] coeff40 = 11'b00001111001; //sfix11_En14
  parameter signed [10:0] coeff41 = 11'b00010010100; //sfix11_En14
  parameter signed [10:0] coeff42 = 11'b00010110000; //sfix11_En14
  parameter signed [10:0] coeff43 = 11'b00011001110; //sfix11_En14
  parameter signed [10:0] coeff44 = 11'b00011101101; //sfix11_En14
  parameter signed [10:0] coeff45 = 11'b00100001110; //sfix11_En14
  parameter signed [10:0] coeff46 = 11'b00100101111; //sfix11_En14
  parameter signed [10:0] coeff47 = 11'b00101010000; //sfix11_En14
  parameter signed [10:0] coeff48 = 11'b00101110010; //sfix11_En14
  parameter signed [10:0] coeff49 = 11'b00110010011; //sfix11_En14
  parameter signed [10:0] coeff50 = 11'b00110110011; //sfix11_En14
  parameter signed [10:0] coeff51 = 11'b00111010001; //sfix11_En14
  parameter signed [10:0] coeff52 = 11'b00111101110; //sfix11_En14
  parameter signed [10:0] coeff53 = 11'b01000001000; //sfix11_En14
  parameter signed [10:0] coeff54 = 11'b01000100000; //sfix11_En14
  parameter signed [10:0] coeff55 = 11'b01000110101; //sfix11_En14
  parameter signed [10:0] coeff56 = 11'b01001000110; //sfix11_En14
  parameter signed [10:0] coeff57 = 11'b01001010100; //sfix11_En14
  parameter signed [10:0] coeff58 = 11'b01001011110; //sfix11_En14
  parameter signed [10:0] coeff59 = 11'b01001100100; //sfix11_En14
  parameter signed [10:0] coeff60 = 11'b01001100110; //sfix11_En14
  ...
  reg  signed [28:0] acc_final; // sfix29_En24
  reg  signed [28:0] acc_out_1; // sfix29_En24
  wire signed [22:0] product_1; // sfix23_En24
  wire signed [10:0] product_1_mux; // sfix11_En14
  wire signed [28:0] prod_typeconvert_1; // sfix29_En24
  wire signed [28:0] acc_sum_1; // sfix29_En24
  wire signed [28:0] acc_in_1; // sfix29_En24
  wire signed [28:0] add_signext_2; // sfix29_En24
  wire signed [28:0] add_signext_3; // sfix29_En24
  wire signed [29:0] add_temp; // sfix30_En24
  reg  signed [28:0] output_register; // sfix29_En24
  ...
  assign preaddmux_a1 = (cur_count == 6'b000000) ? delay_pipeline[8] :
                       ...
                       (cur_count == 6'b010010) ? delay_pipeline[26] :
                       (cur_count == 6'b010011) ? delay_pipeline[27] :
  ...
  assign preaddmux_b1 = (cur_count == 6'b000000) ? delay_pipeline[110] :
                       ...
                       (cur_count == 6'b010010) ? delay_pipeline[92] :
                       (cur_count == 6'b010011) ? delay_pipeline[91] :
  ...
  assign product_1_mux = (cur_count == 6'b000000) ? coeff9 :
                        ...
                        (cur_count == 6'b010010) ? coeff27 :
                        (cur_count == 6'b010011) ? coeff28 :
