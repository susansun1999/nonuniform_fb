...
// Generated on: 2021-05-17 12:09:13
// -------------------------------------------------------------
...
////////////////////////////////////////////////////////////////
  ...
  parameter signed [10:0] coeff11 = 11'b00000000011; //sfix11_En13
  parameter signed [10:0] coeff12 = 11'b00000000010; //sfix11_En13
  parameter signed [10:0] coeff13 = 11'b00000000001; //sfix11_En13
  parameter signed [10:0] coeff14 = 11'b11111111111; //sfix11_En13
  parameter signed [10:0] coeff15 = 11'b11111111100; //sfix11_En13
  parameter signed [10:0] coeff16 = 11'b11111111001; //sfix11_En13
  parameter signed [10:0] coeff17 = 11'b11111110110; //sfix11_En13
  parameter signed [10:0] coeff18 = 11'b11111110011; //sfix11_En13
  parameter signed [10:0] coeff19 = 11'b11111110010; //sfix11_En13
  parameter signed [10:0] coeff20 = 11'b11111110011; //sfix11_En13
  parameter signed [10:0] coeff21 = 11'b11111110101; //sfix11_En13
  parameter signed [10:0] coeff22 = 11'b11111111001; //sfix11_En13
  parameter signed [10:0] coeff23 = 11'b11111111101; //sfix11_En13
  parameter signed [10:0] coeff24 = 11'b00000000001; //sfix11_En13
  parameter signed [10:0] coeff25 = 11'b00000000100; //sfix11_En13
  parameter signed [10:0] coeff26 = 11'b00000000101; //sfix11_En13
  parameter signed [10:0] coeff27 = 11'b00000000100; //sfix11_En13
  parameter signed [10:0] coeff28 = 11'b00000000000; //sfix11_En13
  parameter signed [10:0] coeff29 = 11'b11111111010; //sfix11_En13
  parameter signed [10:0] coeff30 = 11'b11111110100; //sfix11_En13
  parameter signed [10:0] coeff31 = 11'b11111101111; //sfix11_En13
  parameter signed [10:0] coeff32 = 11'b11111101110; //sfix11_En13
  parameter signed [10:0] coeff33 = 11'b11111110010; //sfix11_En13
  parameter signed [10:0] coeff34 = 11'b11111111110; //sfix11_En13
  parameter signed [10:0] coeff35 = 11'b00000010010; //sfix11_En13
  parameter signed [10:0] coeff36 = 11'b00000101101; //sfix11_En13
  parameter signed [10:0] coeff37 = 11'b00001001101; //sfix11_En13
  parameter signed [10:0] coeff38 = 11'b00001101101; //sfix11_En13
  parameter signed [10:0] coeff39 = 11'b00010001001; //sfix11_En13
  parameter signed [10:0] coeff40 = 11'b00010011010; //sfix11_En13
  parameter signed [10:0] coeff41 = 11'b00010011100; //sfix11_En13
  parameter signed [10:0] coeff42 = 11'b00010001010; //sfix11_En13
  parameter signed [10:0] coeff43 = 11'b00001100001; //sfix11_En13
  parameter signed [10:0] coeff44 = 11'b00000100011; //sfix11_En13
  parameter signed [10:0] coeff45 = 11'b11111010100; //sfix11_En13
  parameter signed [10:0] coeff46 = 11'b11101111010; //sfix11_En13
  parameter signed [10:0] coeff47 = 11'b11100100000; //sfix11_En13
  parameter signed [10:0] coeff48 = 11'b11011010000; //sfix11_En13
  parameter signed [10:0] coeff49 = 11'b11010010110; //sfix11_En13
  parameter signed [10:0] coeff50 = 11'b11001111011; //sfix11_En13
  parameter signed [10:0] coeff51 = 11'b11010000110; //sfix11_En13
  parameter signed [10:0] coeff52 = 11'b11010111010; //sfix11_En13
  parameter signed [10:0] coeff53 = 11'b11100010100; //sfix11_En13
  parameter signed [10:0] coeff54 = 11'b11110001101; //sfix11_En13
  parameter signed [10:0] coeff55 = 11'b00000011010; //sfix11_En13
  parameter signed [10:0] coeff56 = 11'b00010101100; //sfix11_En13
  parameter signed [10:0] coeff57 = 11'b00100110011; //sfix11_En13
  parameter signed [10:0] coeff58 = 11'b00110100000; //sfix11_En13
  parameter signed [10:0] coeff59 = 11'b00111100111; //sfix11_En13
