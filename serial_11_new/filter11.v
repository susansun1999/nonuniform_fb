...
// Generated on: 2021-05-17 12:09:31
// -------------------------------------------------------------
...
////////////////////////////////////////////////////////////////
  ...
  parameter signed [10:0] coeff5 = 11'b11111111111; //sfix11_En13
  ...
  parameter signed [10:0] coeff9 = 11'b00000000001; //sfix11_En13
  parameter signed [10:0] coeff10 = 11'b11111111101; //sfix11_En13
  parameter signed [10:0] coeff11 = 11'b11111111011; //sfix11_En13
  parameter signed [10:0] coeff12 = 11'b11111111111; //sfix11_En13
  parameter signed [10:0] coeff13 = 11'b00000000110; //sfix11_En13
  ...
  parameter signed [10:0] coeff17 = 11'b11111111001; //sfix11_En13
  parameter signed [10:0] coeff18 = 11'b00000000110; //sfix11_En13
  parameter signed [10:0] coeff19 = 11'b00000001110; //sfix11_En13
  parameter signed [10:0] coeff20 = 11'b00000000101; //sfix11_En13
  parameter signed [10:0] coeff21 = 11'b11111110110; //sfix11_En13
  parameter signed [10:0] coeff22 = 11'b11111110010; //sfix11_En13
  parameter signed [10:0] coeff23 = 11'b11111111111; //sfix11_En13
  parameter signed [10:0] coeff24 = 11'b00000001011; //sfix11_En13
  parameter signed [10:0] coeff25 = 11'b00000001001; //sfix11_En13
  parameter signed [10:0] coeff26 = 11'b11111111110; //sfix11_En13
  parameter signed [10:0] coeff27 = 11'b11111111011; //sfix11_En13
  ...
  parameter signed [10:0] coeff31 = 11'b11111111001; //sfix11_En13
  parameter signed [10:0] coeff32 = 11'b00000010110; //sfix11_En13
  parameter signed [10:0] coeff33 = 11'b00000100110; //sfix11_En13
  parameter signed [10:0] coeff34 = 11'b00000000001; //sfix11_En13
  parameter signed [10:0] coeff35 = 11'b11111000011; //sfix11_En13
  parameter signed [10:0] coeff36 = 11'b11111000001; //sfix11_En13
  parameter signed [10:0] coeff37 = 11'b00000011100; //sfix11_En13
  parameter signed [10:0] coeff38 = 11'b00001110101; //sfix11_En13
  parameter signed [10:0] coeff39 = 11'b00001001001; //sfix11_En13
  parameter signed [10:0] coeff40 = 11'b11110101000; //sfix11_En13
  parameter signed [10:0] coeff41 = 11'b11101001111; //sfix11_En13
  parameter signed [10:0] coeff42 = 11'b11111001101; //sfix11_En13
  parameter signed [10:0] coeff43 = 11'b00010110000; //sfix11_En13
  parameter signed [10:0] coeff44 = 11'b00011011110; //sfix11_En13
  parameter signed [10:0] coeff45 = 11'b11111110011; //sfix11_En13
  parameter signed [10:0] coeff46 = 11'b11011101010; //sfix11_En13
  parameter signed [10:0] coeff47 = 11'b11100011010; //sfix11_En13
  parameter signed [10:0] coeff48 = 11'b00001111000; //sfix11_En13
  parameter signed [10:0] coeff49 = 11'b00101110000; //sfix11_En13
  parameter signed [10:0] coeff50 = 11'b00010111000; //sfix11_En13
  parameter signed [10:0] coeff51 = 11'b11100000100; //sfix11_En13
  parameter signed [10:0] coeff52 = 11'b11001011100; //sfix11_En13
  parameter signed [10:0] coeff53 = 11'b11110101101; //sfix11_En13
  parameter signed [10:0] coeff54 = 11'b00101111110; //sfix11_En13
  parameter signed [10:0] coeff55 = 11'b00110011011; //sfix11_En13
  parameter signed [10:0] coeff56 = 11'b11111000110; //sfix11_En13
  parameter signed [10:0] coeff57 = 11'b11000100011; //sfix11_En13
  parameter signed [10:0] coeff58 = 11'b11010101111; //sfix11_En13
  parameter signed [10:0] coeff59 = 11'b00011010001; //sfix11_En13
