...
// Generated on: 2021-05-17 12:09:39
// -------------------------------------------------------------
...
////////////////////////////////////////////////////////////////
  ...
  parameter signed [10:0] coeff7 = 11'b00000000000; //sfix11_En13
  parameter signed [10:0] coeff8 = 11'b00000000000; //sfix11_En13
  parameter signed [10:0] coeff9 = 11'b11111111111; //sfix11_En13
  parameter signed [10:0] coeff10 = 11'b00000000001; //sfix11_En13
  parameter signed [10:0] coeff11 = 11'b00000000010; //sfix11_En13
  parameter signed [10:0] coeff12 = 11'b11111111011; //sfix11_En13
  parameter signed [10:0] coeff13 = 11'b00000000000; //sfix11_En13
  parameter signed [10:0] coeff14 = 11'b00000000111; //sfix11_En13
  parameter signed [10:0] coeff15 = 11'b11111111010; //sfix11_En13
  parameter signed [10:0] coeff16 = 11'b11111111010; //sfix11_En13
  parameter signed [10:0] coeff17 = 11'b00000001101; //sfix11_En13
  parameter signed [10:0] coeff18 = 11'b11111111110; //sfix11_En13
  parameter signed [10:0] coeff19 = 11'b11111110011; //sfix11_En13
  parameter signed [10:0] coeff20 = 11'b00000001010; //sfix11_En13
  parameter signed [10:0] coeff21 = 11'b00000000110; //sfix11_En13
  parameter signed [10:0] coeff22 = 11'b11111110101; //sfix11_En13
  parameter signed [10:0] coeff23 = 11'b00000000010; //sfix11_En13
  parameter signed [10:0] coeff24 = 11'b00000000010; //sfix11_En13
  parameter signed [10:0] coeff25 = 11'b00000000011; //sfix11_En13
  parameter signed [10:0] coeff26 = 11'b00000000100; //sfix11_En13
  parameter signed [10:0] coeff27 = 11'b11111101011; //sfix11_En13
  parameter signed [10:0] coeff28 = 11'b00000001010; //sfix11_En13
  parameter signed [10:0] coeff29 = 11'b00000100010; //sfix11_En13
  parameter signed [10:0] coeff30 = 11'b11111010011; //sfix11_En13
  parameter signed [10:0] coeff31 = 11'b11111101111; //sfix11_En13
  parameter signed [10:0] coeff32 = 11'b00001001101; //sfix11_En13
  parameter signed [10:0] coeff33 = 11'b11111011101; //sfix11_En13
  parameter signed [10:0] coeff34 = 11'b11110111001; //sfix11_En13
  parameter signed [10:0] coeff35 = 11'b00001011010; //sfix11_En13
  parameter signed [10:0] coeff36 = 11'b00000010000; //sfix11_En13
  parameter signed [10:0] coeff37 = 11'b11110011011; //sfix11_En13
  parameter signed [10:0] coeff38 = 11'b00000101111; //sfix11_En13
  parameter signed [10:0] coeff39 = 11'b00000111000; //sfix11_En13
  parameter signed [10:0] coeff40 = 11'b11111000100; //sfix11_En13
  parameter signed [10:0] coeff41 = 11'b11111111110; //sfix11_En13
  parameter signed [10:0] coeff42 = 11'b00000001000; //sfix11_En13
  parameter signed [10:0] coeff43 = 11'b00000010010; //sfix11_En13
  parameter signed [10:0] coeff44 = 11'b00000101101; //sfix11_En13
  parameter signed [10:0] coeff45 = 11'b11110000100; //sfix11_En13
  parameter signed [10:0] coeff46 = 11'b00000000111; //sfix11_En13
  parameter signed [10:0] coeff47 = 11'b00011101010; //sfix11_En13
  parameter signed [10:0] coeff48 = 11'b11100110001; //sfix11_En13
  parameter signed [10:0] coeff49 = 11'b11100111011; //sfix11_En13
  parameter signed [10:0] coeff50 = 11'b00111000100; //sfix11_En13
  parameter signed [10:0] coeff51 = 11'b11110110111; //sfix11_En13
  parameter signed [10:0] coeff52 = 11'b10111100111; //sfix11_En13
  parameter signed [10:0] coeff53 = 11'b00111100010; //sfix11_En13
  parameter signed [10:0] coeff54 = 11'b00100110010; //sfix11_En13
  parameter signed [10:0] coeff55 = 11'b10011110010; //sfix11_En13
  parameter signed [10:0] coeff56 = 11'b00011000010; //sfix11_En13
  parameter signed [10:0] coeff57 = 11'b01011011110; //sfix11_En13
  parameter signed [10:0] coeff58 = 11'b10100111110; //sfix11_En13
  parameter signed [10:0] coeff59 = 11'b11011010100; //sfix11_En13
  parameter signed [10:0] coeff60 = 11'b01110011010; //sfix11_En13
